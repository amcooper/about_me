...
function Navbar(props) {
  return (
    <nav id="floatingNav" className="nn">
      <div id="fNavTop">
        <div id="fHomeLink" className="navLink">
          <a href="#" className="navBullet" id="homeHoverHide">&bull;</a>
          <a href="#" className="navText" id="homeHoverShow">home</a>
        </div>
        <div id="fProjectsLink" className="navLink">
          <a href="#" className="navBullet" id="projectsHoverHide">&bull;</a>
          <a href="#" className="navText" id="projectsHoverShow">projects</a>
        </div>
      </div>

      <div id="fLateralLink" className="navLink">
        <div id="fPhotoLink">
          <a href="#" className="navBullet lateralHoverHide">&lt;</a>
          <a href="#" className="lateralHoverShow"><span className="navText">photo&nbsp;</span><span className="navBullet">&lt;</span></a>
        </div>
        <div id="fAboutSlash">
          <a href="#" className="navBullet">/</a>
        </div>
        <div id="fBioLink">
          <a href="#" className="navBullet lateralHoverHide">&gt;</a>
          <a href="#" className="lateralHoverShow"><span className="navBullet">&gt;</span><span className="navText">&nbsp;bio</span></a>
        </div>
      </div>

      <div id="fContactLinks" className="navLink">
        <ul>
          <li id="fGmailLink">
            <div id="gmailHoverHide" className="navBullet">&bull;</div>
            <a href="mailto:amcooper+website@gmail.com" title="Gmail" target="_blank"><img src="images/gmail-64-color.png" id="gmailHoverShow" /></a>
          </li>
          <li id="fGithubLink">
            <div id="githubHoverHide" className="navBullet">&bull;</div>
            <a href="https://github.com/amcooper" title="GitHub" target="_blank"><img src="images/github-64-color.png" id="githubHoverShow" /></a>
          </li>
          <li id="fLinkedinLink">
            <div id="linkedinHoverHide" className="navBullet">&bull;</div>
          ...
          <li id="fWordpressLink">
            <div id="wordpressHoverHide" className="navBullet">&bull;</div>
...
function Home(props) {
    ...
    <div>
  		<div id="landing">
  	    <p className="nt" id="lineOne"><span className="hot hotAbout" id="aboutLink" onClick={() => props.onClick("about")}>a</span><span className="willHide">dam_</span></p>
